...
(function (global) {
    ...
    var DICT = {
        en: {
            ...
            'about.role': 'Visual Designer — London, UK · Available for immediate start',
        ...
        pt: {
            ...
            'nav.lastUpdated': 'Última atualização · 21 de agosto de 2026',
            'menu.motion': 'Motion Design',
            ...
            'about.role': 'Designer Visual — Londres, Reino Unido  ·  Disponível para início imediato',
    ...
    var SERVICES_PT = {
        ...
        'Illustration Support': 'Apoio de Ilustração',
        'Gift Card Design': 'Design de Cartões Presente',
        'Brand Storytelling': 'Narrativa de Marca',
        'Pattern Application': 'Aplicação de Padrões',
        'Email + Mobile UI': 'UI para Email + Mobile',
        'Influencer Collaboration': 'Colaboração com Influenciadores',
        'Concept': 'Conceito',
        'Advertising Design': 'Design Publicitário',
        'Creative Direction': 'Direção Criativa',
        'AI Video Experimentation': 'Experimentação de Vídeo com IA',
        'Motion Design': 'Motion Design',
        'Visual Development': 'Desenvolvimento Visual',
    ...
    var UI_PT = {
        ...
        'AI Experiment': 'Experiência com IA',
        'Gold': 'Ouro'
    };
    ...
    var METRIC_LABEL_PT = {
        ...
        'Assets Delivered': 'Recursos Entregues',
        'Campaign assets delivered': 'Recursos de campanha entregues',
